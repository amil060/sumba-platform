      ...
      <div className="flex min-h-screen">
        ...
        <section className="flex-1 p-8">
          ...
          <div className="mt-8 space-y-5">
            <div className="rounded-2xl border border-rose-500/20 bg-white/5 p-6">
              <div className="flex items-start justify-between gap-4">
                ...
                <button className="rounded-xl bg-rose-500/20 px-4 py-2 text-sm font-medium text-rose-300 hover:bg-rose-500/30">
                  View
                </button>
              </div>
            </div>
